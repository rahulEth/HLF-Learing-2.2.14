...
createChannel() {
	...
	peer channel create -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com -c $CHANNEL_NAME -f ./${CHANNEL_NAME}.tx --outputBlock ./${CHANNEL_NAME}.block --tls --cafile $ORDERER_CA
}
