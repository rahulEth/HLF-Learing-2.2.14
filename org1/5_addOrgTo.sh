...
addOrg4(){
    getGlobalPeer0Org1
    jq -s '.[0] * {"channel_group":{"groups":{"Application":{"groups": {"Org4MSP":.[1]}}}}}' config.json ../addOrgToExistingChannel/org4.json > modified_config.json
