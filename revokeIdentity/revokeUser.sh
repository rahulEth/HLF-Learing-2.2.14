...
export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/../org1/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt

export CORE_PEER_ADDRESS=localhost:7051

export FABRIC_CA_CLIENT_HOME=${PWD}/../org1/organizations/peerOrganizations/org1.example.com/
export CORE_PEER_MSPCONFIGPATH=${PWD}/../org1/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp
...
# export CORE_PEER_MSPCONFIGPATH=${PWD}/../org1/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp
